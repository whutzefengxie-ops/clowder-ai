...
describe('SecretScanner', () => {
  ...
  it('does not exempt repeated schema-looking fields from high-entropy secret detection', () => {
    const content = 'correlation key = configurationPath/configurationPath/configurationPath\n';
